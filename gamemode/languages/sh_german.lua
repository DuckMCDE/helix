...
LANGUAGE = {
    ...
    helpCommands = "Kommandoparameter mit <Pfeilen> sind Voraussetzung, während [Klammern] optional sind.",
    ...
    maxCharacters = "Du kannst keine weiteren Charaktere erstellen!",
    player = "Spieler",
    finish = "Bestätigen",
    ...
    buy = "Kaufen",
    vendorWelcome = "Willkommen in meinem Laden, wie kann ich behilflich sein?",
    ...
    chgNameDesc = "Gebe den Charakter Namen unten ein.",
    ...
    optdShowIntro = "Zeigt die Helix Einführen beim nächsten Verbinden. Wird nach dem ersten anschauen automatisch deaktiviert.",
    ...
    optdChatNotices = "Zeige alle Hinweise von oben-rechts im Chat an.",
    ...
    optdAltLower = "Versteckt Hände wenn sie an deinem Körper herunterhängen.", -- @todo remove me
    ...
    optThirdpersonVertical = "Kamerahöhe",
    ...
    optThirdpersonCrouchOffset = "Kamerahöhe beim Kriechen",
    ...
    optMinimalTooltips = "Minimale HUD Tipps",
    optdMinimalTooltips = "Ändert die HUD Tipps um weniger auffällig zu sein.",
    ...
    optChatFontScale = "Chat Schriftgröße",
    optdChatFontScale = "Die Größe der Schrift im Chat.",
    optChatOutline = "Chat Schriftrand",
    optdChatOutline = "Größe des Randes um die Schrift im Text.",
    ...
    cmdGiveMoney = "Gibt dem Spieler den du anschaust die angegebene Menge Geld.",
    ...
    cmdMapRestart = "Führt nach der angegebenen Zeit einen Map Neustart aus.",
    cmdPanelAdd = "Platziert ein Webpanel.",
    ...
    cmdDoorSetOwnable = "Macht die Tür auf die du schaust wieder besitzbar.",
    cmdDoorSetFaction = "Setzt die Tür auf die du schaust als Besitz einer Fraktion",
